...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/v1/64_k5mn15tbf9syxd9d2sp8c0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/wen/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/wen/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="35.6764"
	TMUX_POWERLINE_SEG_WEATHER_LON="139.6500"
# }
